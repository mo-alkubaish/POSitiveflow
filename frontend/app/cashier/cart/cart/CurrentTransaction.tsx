...
import products from '/Users/abdullah/Documents/GitHub/POSitiveflow/frontend/app/data/cashierProducts.json';
...
const CurrentTransaction = () => {
    ...
    return (
        <div className="card bg-white shadow-xl p-4 text-black w-full sm:w-[600px] md:w-[795px] h-[435px]">
            ...
            <div className="flex justify-end mt-4">
                <button className="btn bg-black text-white w-40 h-10 px-4">Pay</button>
            </div>
        </div>
    );
};
